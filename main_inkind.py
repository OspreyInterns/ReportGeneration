...
class Application(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.sales['text'] = 'Generate Sales In Kind Report'
...
if os.path.isfile('Dyeminish-template.xlsx') and os.path.isfile('Rods-Template.xlsx') \
        and os.path.isfile('Sales-Template-inkind.xlsx') and os.path.isfile('Slide-Template.pptx'):
    ...
    if not os.path.isfile('Sales-Template-inkind.xlsx'):
        print('Missing Sales-Template-inkind.xlsx')
